...
demonstration scenarios, and unselected feature variants.
...
checker, while a verdict service contains the property-specific logic. YAML
...
properties that can be checked close to the observed application. It
corresponds to the traditional organisation in
Figure~\ref{fig:org-traditional}: the application and the complete monitoring
pipeline share one location and one clock, so the records form a totally
ordered trace that a single monitor process analyses.
