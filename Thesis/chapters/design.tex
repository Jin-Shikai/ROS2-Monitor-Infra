...
This chapter explains how I designed the monitoring infrastructure. The design
starts from the feature model that I developed during the pre-phase. I used the
model as a map of the design space rather than as an implementation checklist:
it made clear which parts of ROS~2 monitoring could reasonably fit into one
thesis prototype and which parts should remain outside the scope.

\section{Feature Model as Design Input}

Figure~\ref{fig:feature-model} shows the feature model from the pre-phase. It
...
implementation paradigm. When I built this model, the main lesson was that
...
\begin{figure}[htbp]
    ...
    \caption{Feature model used during the pre-phase to explore the ROS~2
    monitoring infrastructure domain.}
...
I also wanted processing to happen early in the pipeline. Raw ROS~2 messages
