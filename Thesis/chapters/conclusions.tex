...
runtimes can run together or be connected through a configured transport.
...
The main contribution is an architectural and implementation boundary
...
hiding application and property decisions. The evaluation establishes feasibility 
and functional correctness for the reported configurations.
