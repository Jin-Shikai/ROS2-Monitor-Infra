...
\newcommand\reporttitle{Problem Statement: Configurable Monitoring Infrastructure for ROS2 Applications}

% Insert course code, name, quartile number and year (or any other subtitle)
\newcommand\reportsubtitle{
Preparation Phase Report (2026)
}
